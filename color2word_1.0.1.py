"""Color to Word 1.0.1 - Convert colors to words.
...
def aboutbox():
    ...
    url_title.configure(text="Color to Word 1.0.1", font=("Arial",15), anchor='center')
    ...
    url_label2.configure(text="https://fonazzastent.com/turn-colors-into-words/", anchor='center')
    url_label2.bind("<Button-1>", lambda e: callback("https://fonazzastent.com/turn-colors-into-words/"))
...
A tool to convert a custom word list into a word+color list named \
wordcolor.txt is included with the program (generate_list.exe).\n\
